...
if ( have_posts() ) : while ( have_posts() ) : the_post();
  ...
  // MODIFICAÇÃO DOS ARGUMENTOS - RANDOMIZE QUERY POSTS ARGS
 ...
 */
    ...
    // Editado em 03/03/2022 -
    // Adicionado a query nos posts, De acordo com a posição de importação e tb por Curtidas   
    // Resolvido o problema do random na paginação adicionando uma variável Session 
    $args = array(
